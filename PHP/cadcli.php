...
$pdo -> query("INSERT INTO cliente (nome_cli, email_cli, cnpj, cpf, endereco, contato, apelido, id_cli) VALUES ('$nome_cli', '$email_cli', '$CNPJ', '$CPF', '$endereco', '$contato','$apelido', default)");
